...
6. Write some python files to process three files `input.xlsx`,`oral-papers.tsv`and`poster-demo-papers.tsv` ,just need to run `sh pipeline.sh` to generate final `conference.json`.
7. Run `make run`.
